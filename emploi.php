...
<script>
    const API_URL_ENTETE = "http://s1065353875.onlinehome.fr/ml09_wp/wp-json/wp/v2/emploi_texte?embed&acf_format=standard";
    ...
    <main>
        ...
        <h1 style="color: var(--bleu_cerulean);">Trouver un emploi avec la Mission Locale de l’Ariège</h1><br>

        <div id="texte_container"></div>

        <script>
            fetch('http://s1065353875.onlinehome.fr/ml09_wp/wp-json/wp/v2/emploi_texte?embed&acf_format=standard')
            .then(res => res.json())
            .then(data => {
