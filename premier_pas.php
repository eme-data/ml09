...
<script>
    const API_URL_ENTETE = "https://ml09.org/ml09_wp/wp-json/wp/v2/texte_premier_pas?acf_format=standard";
    const CACHE_KEY_ENTETE = "img_entete_premier_pas";
    ...
    <main>
        ...
        <script>
            fetch('https://ml09.org/ml09_wp/wp-json/wp/v2/texte_premier_pas?acf_format=standard')
                .then(res => res.json())
                .then(data => {
            ...
            fetch('https://ml09.org/ml09_wp/wp-json/wp/v2/point?embed&acf_format=standard&per_page=100')
                .then(response => {
                    ...
                    if (!contentType || !contentType.includes('application/json')) {
                        throw new Error('La réponse API n\'est pas du JSON');
                    }
