...
<script>
    const API_URL_ENTETE = "https://ml09.org/ml09_wp/wp-json/wp/v2/sante_texte?embed&acf_format=standard";
    const CACHE_KEY_ENTETE = "img_entete_sante";
    ...
    <main>
        ...
        <script>
            fetch('https://ml09.org/ml09_wp/wp-json/wp/v2/sante_texte?embed&acf_format=standard')
            .then(res => res.json())
            .then(data => {
        ...
        <div class="btn_centre">
            <strong><a class="bnt_jaune" href="paej.php">Contactez le PAEJ</a></strong><br>
        </div><br><br>
