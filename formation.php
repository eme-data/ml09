...
<script>
    const API_URL_ENTETE = "https://ml09.org/ml09_wp/wp-json/wp/v2/formation_texte?embed&acf_format=standard";
    const CACHE_KEY_ENTETE = "img_entete_formation";
    ...
    <main>
        ...
        <script>
            fetch('https://ml09.org/ml09_wp/wp-json/wp/v2/formation_texte?embed&acf_format=standard')
            .then(res => res.json())
            .then(data => {
