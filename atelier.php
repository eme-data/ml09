...
<script>
    const API_URL_ENTETE = "https://ml09.org/ml09_wp/wp-json/wp/v2/atelier_texte?embed&acf_format=standard";
    const CACHE_KEY_ENTETE = "img_entete_atelier";
    ...
    <main>
        ...
        <script>
            fetch('https://ml09.org/ml09_wp/wp-json/wp/v2/atelier_texte?embed&acf_format=standard')
            .then(res => res.json())
            .then(data => {
