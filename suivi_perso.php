...
<head>
    ...
    <title>Suivi personnalisé</title>
...
<script>
    const API_URL_ENTETE = "http://s1065353875.onlinehome.fr/ml09_wp/wp-json/wp/v2/suivi_texte?embed&acf_format=standard";
    ...
    <main>
        ...
        <script>
            fetch('http://s1065353875.onlinehome.fr/ml09_wp/wp-json/wp/v2/suivi_texte?embed&acf_format=standard')
                .then(res => res.json())
                .then(data => {
