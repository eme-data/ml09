...
<head>
    ...
    <title>Suivi personnalisé | ml09</title>
    ...
    <link rel="stylesheet" href="css/suivi_perso.css">
...
<script>
    const API_URL_ENTETE = "https://ml09.org/ml09_wp/wp-json/wp/v2/suivi_texte?embed&acf_format=standard";
    const CACHE_KEY_ENTETE = "img_entete_suivi";
    ...
    <main>
        ...
        <h1 style="color: var(--bleu_cerulean);">Soutien personnalisé pour les jeunes en Ariège</h1><br>

        <div id="texte_container"></div>

        <script>
            fetch('https://ml09.org/ml09_wp/wp-json/wp/v2/suivi_texte?embed&acf_format=standard')
                .then(res => res.json())
                .then(data => {
